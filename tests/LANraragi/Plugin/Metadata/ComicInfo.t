...
note("00 - [れむ] 夜伽妻 [DL版]");
{
    ...
    my $expected_title = "COMIC Anthurium 2021-09 [Digital]";
    ...
    my @tag_array = ($expected_title, $expected_group_tag, $expected_artist_tag, $expected_source_tag, $expected_lang_tag, $expected_genre_tags);
...
note("02 - よつばと！ 第01巻");
{
    ...
    my @tag_array = ($expected_title, $expected_group_tag, $expected_artist_tag, $expected_lang_tag, $expected_genre_tags);
    my $expected_tags = join( ", ", @tag_array );
    is( $returned_tags,  $expected_tags, "correct tags" );
}
...
note("03 - 異種姦オーガズム");
{
    ...
    my @tag_array = ($expected_title, $expected_group_tag, $expected_lang_tag, $expected_genre_tags);
    my $expected_tags = join( ", ", @tag_array );
    is( $returned_tags,  $expected_tags, "correct tags" );
}
